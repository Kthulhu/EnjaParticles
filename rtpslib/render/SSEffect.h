...
namespace rtps
{
    ...
    {
    public:
        SSEffect(ShaderLibrary* lib, SmoothingFilter filter = SmoothingFilter::BILATERAL_GAUSSIAN_BLUR, GLuint width = 600, GLuint height = 800 ,GLfloat pointRadius = 0.5f,bool blending = false);
        ~SSEffect();
        void smoothDepth();
